...
class BuildingTypesControllerTest < ActionController::TestCase
  ...
  test "should create building_type" do
    assert_difference('BuildingType.count') do
      post :create, building_type: { build_time: @building_type.build_time, name: @building_type.name, size_x: @building_type.size_x, size_y: @building_type.size_y, type: @building_type.type }
    end
  ...
  test "should update building_type" do
    patch :update, id: @building_type, building_type: { build_time: @building_type.build_time, name: @building_type.name, size_x: @building_type.size_x, size_y: @building_type.size_y, type: @building_type.type }
    assert_redirected_to building_type_path(assigns(:building_type))
  end
