...
class MovementsControllerTest < ActionController::TestCase
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post :create, movement: { end_tile_id: @movement.end_tile_id, start_tile_id: @movement.start_tile_id, start_time: @movement.start_time }
    end
  ...
  test "should update movement" do
    patch :update, id: @movement, movement: { end_tile_id: @movement.end_tile_id, start_tile_id: @movement.start_tile_id, start_time: @movement.start_time }
    assert_redirected_to movement_path(assigns(:movement))
  end
