...
class MissionsControllerTest < ActionController::TestCase
  ...
  test "should create mission" do
    assert_difference('Mission.count') do
      post :create, mission: { mission_status_id: @mission.mission_status_id, mission_type_id: @mission.mission_type_id }
    end
  ...
  test "should update mission" do
    patch :update, id: @mission, mission: { mission_status_id: @mission.mission_status_id, mission_type_id: @mission.mission_type_id }
    assert_redirected_to mission_path(assigns(:mission))
  end
