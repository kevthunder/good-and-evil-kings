...
class Admin::CastlesControllerTest < ActionController::TestCase
  ...
  test "should create castle" do
    ...
    assert_redirected_to admin_castle_path(assigns(:castle))
  end
  ...
  test "should destroy castle" do
    ...
    assert_redirected_to admin_castles_path
  end
end
