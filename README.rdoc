...
* rails g scaffold soldier_types name:string speed:integer attack:integer defence:integer interception:integer carry:integer recrute_time:integer military:boolean --skip-migration
