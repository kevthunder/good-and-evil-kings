...
* Casern add training spot
* max number building type
* interfaces
  * mission
* more buildings
...
* rails g scaffold building_types name:string type:string build_time:integer size_x:integer size_y:integer predecessor:references --skip-migration
