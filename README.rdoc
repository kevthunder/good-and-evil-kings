...
TODO
* upkeep
  * Modifiable::get_prop_mod allow applier to alter value
    * Modificator::each_with_applier
* max stock
...
* rails g scaffold soldier_types name:string speed:integer attack:integer defence:integer interception:integer carry:integer --skip-migration
...
* rails g scaffold building_types name:string type:string build_time:integer size_x:integer size_y:integer --skip-migration
* rails g scaffold building_types name:string type:string build_time:integer size_x:integer size_y:integer --skip-migration
