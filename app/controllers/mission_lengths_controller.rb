class MissionLengthsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mission_length.save
        format.html { redirect_to @mission_length, notice: 'Mission length was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @mission_length.update(mission_length_params)
        format.html { redirect_to @mission_length, notice: 'Mission length was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to mission_lengths_url }
      format.json { head :no_content }
    end
  end
