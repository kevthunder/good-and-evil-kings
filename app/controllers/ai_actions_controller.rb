class AiActionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ai_action.save
        format.html { redirect_to @ai_action, notice: 'Ai action was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @ai_action.update(ai_action_params)
        format.html { redirect_to @ai_action, notice: 'Ai action was successfully updated.' }
  ...
  def destroy
    @ai_action.destroy
    respond_to do |format|
      format.html { redirect_to ai_actions_url }
      format.json { head :no_content }
    end
  end
