    ...
    def create
      ...
      respond_to do |format|
        if @name_fragment.save
          format.html { redirect_to [:admin, @name_fragment], notice: 'Name fragment was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @name_fragment.update(name_fragment_params)
          format.html { redirect_to [:admin, @name_fragment], notice: 'Name fragment was successfully updated.' }
