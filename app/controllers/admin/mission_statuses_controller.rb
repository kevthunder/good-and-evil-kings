class MissionStatusesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mission_status.save
        format.html { redirect_to @mission_status, notice: 'Mission status was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @mission_status.update(mission_status_params)
        format.html { redirect_to @mission_status, notice: 'Mission status was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to mission_statuses_url }
      format.json { head :no_content }
    end
  end
