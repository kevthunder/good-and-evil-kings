module Admin
  class BuildingTypesController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @building_type.save
          format.html { redirect_to [:admin, @building_type], notice: 'Building type was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @building_type.update(building_type_params)
          format.html { redirect_to [:admin, @building_type], notice: 'Building type was successfully updated.' }
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to admin_building_types_url }
        format.json { head :no_content }
      end
    end
