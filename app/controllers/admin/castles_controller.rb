module Admin
  class CastlesController < AdminController
    ...
    def create
      ...
      respond_to do |format|
        if @castle.save
          format.html { redirect_to [:admin, @castle], notice: 'Castle was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @castle.update(castle_params)
          format.html { redirect_to [:admin, @castle], notice: 'Castle was successfully updated.' }
